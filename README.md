...
- 파일 크기가 너무 큰 matrix.def untracking 및 `download_matrxi_def.sh` 추가 (repo release 에서 다운로드)
...
[mecab-ko 다운로드 페이지](https://drive.google.com/drive/folders/1MOxl50tV0KVc29vBANB05LtPLlI8J3Mm?usp=sharing) 에서 mecab-ko의 소스를 다운 받고 설치합니다.
...
[mecab-ko-dic 다운로드 페이지](https://drive.google.com/drive/folders/1STH9WUG7_flOjFuGIKqnmebhSfQaHbzM?usp=sharing) 에서 mecab-ko-dic의 최신 버전을 다운 받습니다.
